...
/**
 * This {@link AsyncTask} class is used to get posts by their likes.
 *
 * @author Olivier Gonçalves
 */
public final class WBPostListByLikes extends AsyncTask<String, Void, List<ServerResponse>> {

    private IPostListByLikes mListener;

    public void setIPostListByLikes(IPostListByLikes listener) {
        mListener = listener;
    }
    ...
    protected List<ServerResponse> doInBackground(String... params) {
        ...
        ServerRequest postRequest = new ServerRequest(ServerRequest.GET, APIUtils.POSTS_BY_LIKES);
    ...
    public interface IPostListByLikes {
